...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAkFolder_Statics::NewProp_UnrealFolderPath = { "UnrealFolderPath", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkFolder, UnrealFolderPath), METADATA_PARAMS(Z_Construct_UClass_UAkFolder_Statics::NewProp_UnrealFolderPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkFolder_Statics::NewProp_UnrealFolderPath_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAkFolder_Statics::NewProp_WwiseFolderPath = { "WwiseFolderPath", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkFolder, WwiseFolderPath), METADATA_PARAMS(Z_Construct_UClass_UAkFolder_Statics::NewProp_WwiseFolderPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkFolder_Statics::NewProp_WwiseFolderPath_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Classes_AkFolder_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Classes_AkFolder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAkFolder, UAkFolder::StaticClass, TEXT("UAkFolder"), &Z_Registration_Info_UClass_UAkFolder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkFolder), 1442293614U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Classes_AkFolder_h_153755470(TEXT("/Script/AkAudio"),
		Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Classes_AkFolder_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Classes_AkFolder_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
