...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AudiokineticTools_Private_AssetManagement_AkFolderSearchFilter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AudiokineticTools_Private_AssetManagement_AkFolderSearchFilter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAkFolderSearchFilter, UAkFolderSearchFilter::StaticClass, TEXT("UAkFolderSearchFilter"), &Z_Registration_Info_UClass_UAkFolderSearchFilter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkFolderSearchFilter), 4195195683U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AudiokineticTools_Private_AssetManagement_AkFolderSearchFilter_h_1509200490(TEXT("/Script/AudiokineticTools"),
		Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AudiokineticTools_Private_AssetManagement_AkFolderSearchFilter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AudiokineticTools_Private_AssetManagement_AkFolderSearchFilter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
