...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FMovieSceneAkAudioRTPCTemplate>()
{
	...
	struct Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Private_MovieSceneAkAudioRTPCTemplate_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Private_MovieSceneAkAudioRTPCTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneAkAudioRTPCTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneAkAudioRTPCTemplate_Statics::NewStructOps, TEXT("MovieSceneAkAudioRTPCTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneAkAudioRTPCTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneAkAudioRTPCTemplate), 2665050170U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Private_MovieSceneAkAudioRTPCTemplate_h_2450398907(TEXT("/Script/AkAudio"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Private_MovieSceneAkAudioRTPCTemplate_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MechaJammin_Plugins_Wwise_Source_AkAudio_Private_MovieSceneAkAudioRTPCTemplate_h_Statics::ScriptStructInfo),
		nullptr, 0);
